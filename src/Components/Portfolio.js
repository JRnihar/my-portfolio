...
import EasyDocs from '../img/Easy-Doc.png'
                ...
                <div class="col">
                    <div class="card w-100 h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-white  mt-3">This is a MERN Stack project.This web site has a magical & interesting feature which is that every normal user and every Admin can write and post their blog. <br />[More Details Please check github repo.]</p>
                            <p><a href="https://github.com/jubaer-ibn-johir/documentation-site-client" target='_blank'><i class="icon text-white fa-brands fa-github"></i></a><a href="https://endgame-53c9b.web.app/" target='_blank'><i class="icon fa-solid ms-3 fa-arrow-up-right-from-square text-white"></i></a></p>
                    ...
                    <div class="card w-100 h-100">
                       <div >
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-white mt-3">This is simple web application which have Simple ordering system with a dashboard to manage orders.A system with ability to determine admin or customer to show interactive options based on the role.</p>
                ...
                <div class="col">
                    <div class="card w-100 h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-white  mt-3">This is a MERN Stack web application.This is specially made for CURD Operation.This web site have Deleting system,manage products system with filtering and Simple ordering system .A system with ability to determine customer to show interactive options. </p>
                ...
                <div class="col">
                    <div class="card w-100 h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-white  mt-3">It’s an E-commerce base website. A web application which users can calculate their shopping and review their products. Users also can delete their products.</p>
                ...
                <div class="col">
                    <div class="card w-100 h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-white  mt-3">A simple Front-end web application using raw javascript.</p>
