                ...
                <div className="row">
                    ...
                    className="col-md-6">
                        <h4 className='text-white lead mt-5 '>
                            Hello! I'm Monirul Islam, a passionate Front-End Developer. I develop web applications  and desktop applications. My core skill is based on JavaScript,ReactJS and I love to do most of the things using JavaScript,ReactJS. I love to make the web more open to the world. I am studding with a bachelor's degree  from National university at Chittagong, Bangladesh . I am available for any kind of job opportunity that suits my interests. <br />
                            <div className='mt-5'>
